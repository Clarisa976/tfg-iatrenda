PASO 1: AGREGAR DEPENDENCIA AWS
...
PASO 2: CREAR EL SERVICIO DE BACKUP

Crea archivo: backend/src/Services/BackupService.php
...
class BackupService {
    ...
    public function createDatabaseDump(): array {
        ...
        // Usar tu DATABASE_URL de PostgreSQL existente
        $databaseUrl = $_ENV['DATABASE_URL'];
        $command = "pg_dump \"{$databaseUrl}\" --no-owner --no-privileges > \"{$filePath}\"";
